    ...
    question:
      -
        ...
        content:
          -
            type: text
            text: '¿Tienes picor en el cuero cabelludo?'
    answers: |-
      Sí, constantemente
      Sí, de forma ocasional
      Solo cuando está sucio o sudado
      No
      No estoy seguro
    type: new_set
    enabled: true
  -
    id: ZVJ4s4g1TCOoEJnExLxq0
    question:
      -
        type: paragraph
        content:
    ...
    question:
      -
        ...
        content:
          -
            type: text
            text: '¿Sientes dolor al tocar el cuero cabelludo?'
    answers: |-
      Sí, mucho
      Sí, pero solo en algunas zonas
      A veces
      No
      No estoy seguro
    type: new_set
    ...
    question:
      -
        ...
        content:
          -
            type: text
            text: '¿Tu cuero cabelludo se engrasa rápido?'
    answers: |-
      Sí, en menos de 24 horas
      Sí, en 1–2 días
      No, tarda varios días
      No, tengo el cuero cabelludo seco
      No estoy seguro
    type: new_set
    enabled: true
order: 5
